# Growth Marketing AI Tools Setup

## Overview

This repository documents my process of setting up AI-assisted tools for a portfolio task related to the Junior Growth Marketing Specialist role.

The goal of this task is to show my ability to follow instructions, learn new tools quickly, document my process clearly, and use AI tools to support research, productivity, and problem-solving.
...
During this setup process, I faced a few challenges:
...
To solve these issues, I followed a step-by-step approach:

- I broke the task into smaller parts instead of trying to complete everything at once.
- I used official websites such as Cursor and GitHub to avoid unsafe downloads.
